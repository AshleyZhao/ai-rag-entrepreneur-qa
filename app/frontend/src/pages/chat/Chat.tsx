                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h2 className={styles.chatEmptyStateSubtitle}>Currently we've loaded interview transcripts from Jack Ma, Elon Musk, and Ma Hua Teng. Ask anything or try an example.</h2>
